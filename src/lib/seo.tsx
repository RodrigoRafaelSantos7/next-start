...
// But I recommend to set the canonical URL for each page (export const metadata = getSEOTags({canonicalUrlRelative: "/"});) and
// also set the tittle (export const metadata = getSEOTags({title: "My page title"});)
